...
top10words_folder = 'Output/Tweets/Top10Words'
lemmas_folder = 'Output/Tweets/lemmas'

# Make sure the plotting folder exists
plotting_folder = 'Output/Tweets/TermTimelines'
delete_create_folder(plotting_folder)

for top_user_file in os.listdir(top10words_folder):
    if top_user_file.endswith('.csv'):
        # Read top 10 words for the user
        user_terms_df = pd.read_csv(os.path.join(top10words_folder, top_user_file))
